...
for row in df.itertuples():
    list_name = row.lists
    card_name = row.cards
    # Criar card com Checklist e CHeckItems
    wday = []#0=monday/1=tuesday/2=wed/3=thursday/4=friday/5=saturday/6=sunday
    wday += [int(i) for i in row.weekdays.split(',')]
    print(list_name, card_name, wday)
    tc.criar_card_mensal(org_name, board_name, list_name, card_name, checklist_name, checkitem_name, initial_date, final_date, wday, cal)
